...
//---------------------------------FIM DO ENVIO DO FORMULÁRIO DE CADASTRO--------------------------------------
    ...
    $(botaoAdicionar).click(function () {
        ...
        var linha = $('<div class="conteudoIndividual">' +
                ...
                '<div class="form-group col-md-4"><label><span class="field">Origem:</span></label><input class="form-control" type="text" name="origem' + i + '"/></div>' +
                '<div class="form-group col-md-4"><label><span class="field">Destino:</span></label><input class="form-control" type="text" name="destino' + i + '"/></div>' +
                '<div class="form-group col-md-2"><label><span class="field">Hora de Pouso:</span></label><input id="tvpe" class="form-control"  type="time" name="hora_de_pouso' + i + '" /></div>' +
