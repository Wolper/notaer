<div class="content list_content">
    ...
    <section class="list_emp">
        ...
        $readVoo->ExeRead("app_empresas", "ORDER BY empresa_status ASC, empresa_title ASC LIMIT :limit OFFSET :offset", "limit={$Pager->getLimit()}&offset={$Pager->getOffset()}");
