...
define('SITENAME', 'Notaer Online');
define('SITEDESC', 'Sistema de Manutenção de Aeronaves do Espírito Santo');

// DEFINE A BASE DO SITE ####################
define('HOME', 'http://localhost/SysNotaer/');
define('THEME', 'notaeronline');
