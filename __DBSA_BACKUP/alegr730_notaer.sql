...
--
-- Host: localhost
-- Generation Time: 13-Dez-2017 às 07:18
...
(175, 1, 'Vila Velha', 's maria de jetiba', '10:20:00', '40'),
(175, 2, 'santa maria', 'sihc', '11:00:00', '30');
...
(175, '2017-12-08', 4488, 1, 'Pinheiro', 'Laura', 'Erick', 'Freitas', 'dflkmcsam', '10:18:00', '11:02:00', 0, 44, 2, '70', 'I3 - Instrução revisória/Experiência Recente', '0');
...
(1, 'Chrome', '136', '2017-12-08 15:50:22'),
...
ALTER TABLE `ws_siteviews`
  ADD PRIMARY KEY (`siteviews_id`), ADD KEY `idx_1` (`siteviews_date`);

--
-- Indexes for table `ws_siteviews_agent`
--
ALTER TABLE `ws_siteviews_agent`
  ADD PRIMARY KEY (`agent_id`), ADD KEY `idx_1` (`agent_name`);
...
--
ALTER TABLE `aeronave`
  MODIFY `idAeronave` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `tipo_inspecao`
  MODIFY `idInspecao` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT for table `voo`
--
ALTER TABLE `voo`
  MODIFY `idvoo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=176;
--
...
--
ALTER TABLE `ws_siteviews`
  MODIFY `siteviews_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
