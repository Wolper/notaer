...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Jan-2018 às 17:24
...
INSERT INTO `inspecao` (`idAeronave`, `id_tipo_inspecao`, `in_anvInspecao`, `in_dataInspecao`, `in_tsnInspecao`, `in_tsoInspecao`, `vencimento_for_time`, `vencimento_for_date`, `disponivel_for_date`, `disponivel_for_time`, `idInstalacao`) VALUES
(1, 2, '123', '2017-12-12', '987', '876', NULL, NULL, NULL, NULL, 1);
...
--
ALTER TABLE `inspecao`
  MODIFY `idInstalacao` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tipo_inspecao`
  MODIFY `idInspecao` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
