        ...
        <section class="main_lastnews">
            ...
            <nav class="guia_comercial">
                ...
                <div class="tab comer">
                    ...
                    $empcat = 'onde-comer';
                    $voo = new Read;
                    $voo->ExeRead("app_empresas", "WHERE empresa_status = 1 AND empresa_categoria = :empcat ORDER BY rand() LIMIT 4", "empcat={$empcat}");
                    if (!$voo->getResult()):
                        WSErro("Desculpe, não existem empresas cadastradas na categoria ONDE COMER. Favor, volte depois!", WS_INFOR);
                    else:
                        foreach ($voo->getResult() as $voo):
                            $View->Show($voo, $tpl_empresa);
                        endforeach;
                    endif;
                    ?>
                </div>
